...
export const HeroSec = () => {
  return (
    <div className='h-[100vh] lg:h-[90vh] flex w-full justify-center items-center'>
          ...
          <div className=' absolute bottom-[30px] flex justify-between items-center w-[540px]'>
            <div className='flex gap-[10px]'>
              ...
              <div className='flex flex-col'>
                <p className='text-[16px] font-bold text-center'>Hritik Sharma</p>
                <p className='text-[14px] text-black/60 font-bold text-center'>15 March 2025</p>
              </div>
            </div>
